    ...
    },
    {
      ...
      value: (
        <div className="flex flex-row space-x-4">
          <a href="tel:+233204185163" className="text-gray-700 dark:text-gray-300 hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-300">
            +233 20 418 5163
          </a>
          <a href="tel:+233537270382" className="text-gray-700 dark:text-gray-300 hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-300">
            +233 53 727 0382
          </a>
        </div>
      ),
      ...
      >
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 sm:gap-12">
                    ...
                    <div>
                      ...
                      {info.href ? (
                        <div className="flex items-center gap-2">
                          <a
                            href={info.href}
                            className="text-gray-600 dark:text-gray-300 hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-300 relative z-20"
                            style={{
                              textShadow: '1px 1px 2px rgba(0, 0, 0, 0.1)'
                            }}
                          >
                          ...
                          {info.title === 'Email' && (
                            ...
                            >
                              <Copy size={14} className="text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400" />
                            </motion.button>
                          )}
                        </div>
                      ) : (
                  ...
                  <div className="flex flex-wrap justify-center gap-x-8 gap-y-2">
                    {[
                      ...
                      <motion.button
                        ...
                        className="text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-white transition-colors duration-300 text-sm font-medium"
                        whileHover={{ y: -2 }}
                      >
                        {link.label}
                      </motion.button>
          ...
          <motion.div variants={itemVariants} className="order-1 lg:order-2">
            <div
              className="bg-white dark:bg-black/70 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-gray-200 dark:border-teal-500/30 shadow-xl relative z-10 dark:bg-gradient-to-br dark:from-black/80 dark:to-slate-900/60"
              style={{
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-black/50 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300 relative z-20"
                      style={{
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={isMobile ? 4 : 6}
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-black/50 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300 resize-none relative z-20"
                    style={{
                      backdropFilter: 'blur(10px)'
                    }}
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <motion.button
                    ...
                    className="sm:w-auto bg-teal-600 hover:bg-teal-700 text-white px-6 py-4 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2"
