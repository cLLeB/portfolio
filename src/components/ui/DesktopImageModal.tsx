...
interface DesktopImageModalProps {
    isOpen: boolean
    onClose: () => void
...
/**
 * Desktop / tablet image modal. Rendered only by ImageModal, and only on
 * viewports >= 768px, so its body scroll lock can never run alongside the
 * mobile one.
 */
const DesktopImageModal = ({ isOpen, onClose, imageSrc, alt }: DesktopImageModalProps) => {
...
export default DesktopImageModal
